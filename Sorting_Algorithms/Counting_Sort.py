...
"""
Counting Sort хорош для сортировки массивов с небольшим диапазоном целых чисел.

Преимущества:
* Очень быстрый для данных с ограниченным диапазоном значений.
* Время работы O(n + k), где k - диапазон значений.

Недостатки:
* Не подходит для данных с большим диапазоном значений.
* Требует дополнительной памяти для хранения счетчиков.
"""