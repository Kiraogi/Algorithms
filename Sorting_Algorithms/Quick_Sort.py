...
"""
Преимущества:
* Очень быстрая на практике (O(n log n) в среднем).
* Хорошо работает с кэш-памятью.

Недостатки:
* Худшее время работы O(n^2) в худшем случае.
* Неустойчивый (не сохраняет порядок равных элементов).
"""